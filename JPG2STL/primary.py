...
class Triangles:
    ...
    def f16_combine_outerinners(self, outerlist,
                                innerlists):  # NEED TO PROBABLY ADD A METHOD TO CHECK FOR INTERSECTIONS
                ...
                for point2 in outerlist:
                    ...
                    for pt3 in outerlist:
                        if point2 == pt3:
                            ...
                            newres = sec.s9_checkintersect(point1, point2, pt3,
                                                           outerlist[outerct - 1])  # Takes 4 points
